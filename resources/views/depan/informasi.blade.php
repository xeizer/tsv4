...
<div class="container py-3">
    <div class="header-title">
        <h2 class="heading-title text-info">Berita dan Informasi</h2>
    </div>
    @foreach($data as $a)
    <div class="card-2">
        <div class="row ">
            ...
            <div class="col-md-8">
                ...
                <div class="extra">
                    <span class="right">
                  <a class="btn btn-sm btn-common animated fadeInUp pull-right" href="{{route('informasi.detil',['id'=>$a->id])}}">Selengkapnya</a>
                </span>
                    <span>
