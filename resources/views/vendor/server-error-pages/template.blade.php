    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="jumbotron">
                ...
                @if(trans("server-error-pages::server-error-pages.$code.button.link_to") ==='home')
                {{route('index')}}
                @elseif(trans("server-error-pages::server-error-pages.$code.button.link_to") === 'reload')
                {!!url()->current()!!}
                @else
                {!!url()->previous()!!}
                @endif"><span class="green">{!! trans("server-error-pages::server-error-pages.$code.button.name") !!}</span></a></p>
            </div>
        </div>
        <div class="container">
