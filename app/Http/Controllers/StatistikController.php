                    ...
                    if ($tahunlulus == 0) {
                        ...
                        $data = [
                            ...
                            'kurang6' => F5m::select('mahasiswams.*', 'f5ms.*', DB::raw('f502+f503 as total'))
                                ...
                                ->where('mahasiswams.tahun_lulus', $tahunlulus)
                                ->whereRaw('f502+f503 <= 6')->count(),
                            'lokal' => F8a::select('mahasiswams.id, mahasiswams.prodi_id, f8as.*')
                                ->join('mahasiswams', 'f8as.mahasiswam_id', '=', 'mahasiswams.id')
                                ->where('f8a', 1)
                                ->where('mahasiswams.tahun_lulus', $tahunlulus)
                                ->count(),
                            'nasional' => F8a::select('mahasiswams.id, mahasiswams.prodi_id, f8as.*')
                                ->join('mahasiswams', 'f8as.mahasiswam_id', '=', 'mahasiswams.id')->where('f8a', 2)->count(),
                            'internasional' => F8a::select('mahasiswams.id, mahasiswams.prodi_id, f8as.*')
                ...
                if ($tahunangkatan == 0) {
                    if ($tahunlulus == 0) {
                        ...
                        $data = [
                            ...
                            'lebih18' => F5m::select('mahasiswams.id, mahasiswams.prodi_id, f8ms.*', DB::raw('f502+f503 as total'))
                                ->join('mahasiswams', 'f5ms.mahasiswam_id', '=', 'mahasiswams.id')
                                ->join('f8ms', 'f5ms.mahasiswam_id', '=', 'f8ms.mahasiswam_id')
                                ->where('f8ms.f8', 1)
                                ->where('prodim_id', $prodi)
                                ->whereRaw('f502+f503 >= 18')
                                ->count(),
                            'antara618' => F5m::select('mahasiswams.id, mahasiswams.prodi_id, f8ms.*', DB::raw('f502+f503 as total'))
                                ->join('mahasiswams', 'f5ms.mahasiswam_id', '=', 'mahasiswams.id')
                                ->join('f8ms', 'f5ms.mahasiswam_id', '=', 'f8ms.mahasiswam_id')
                                ->where('f8ms.f8', 1)
                                ->where('prodim_id', $prodi)
                                ...
                                ->whereRaw('f502+f503 < 18')
                                ->count(),
                            'kurang6' => F5m::select('mahasiswams.id, mahasiswams.prodi_id, f8ms.*', DB::raw('f502+f503 as total'))
                                ->join('mahasiswams', 'f5ms.mahasiswam_id', '=', 'mahasiswams.id')
                                ->join('f8ms', 'f5ms.mahasiswam_id', '=', 'f8ms.mahasiswam_id')
                ...
                if ($tahunlulus == 0) {
                    ...
                    $data = [
                        ...
                        'biayasendiri' => F12m::select('mahasiswams.id, mahasiswams.prodi_id, f12ms.*')
                            ->join('mahasiswams', 'f12ms.mahasiswam_id', '=', 'mahasiswams.id')
                            ->where('f121', 1)->where('angkatan', $tahunangkatan)
                            ->where('mahasiswam.prodim_id', $prodi)
                            ->where('tahun_lulus', $tahunlulus)->count(),
                        'adik' => F12m::select('mahasiswams.id, mahasiswams.prodi_id, f12ms.*')
                            ->join('mahasiswams', 'f12ms.mahasiswam_id', '=', 'mahasiswams.id')->where('f121', 2)->where('angkatan', $tahunangkatan)
                            ->where('prodim_id', $prodi)
